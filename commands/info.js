...
module.exports.run = (bot, message, args) => {
  var msgArray = []; 
  msgArray.push(`Hello, I'm Zanity version 1.0, a Discord bot running on NodeJS Version 8, Lemonade API and HulkbotAPI.`);
  msgArray.push(`My birthday is August 2018`)
  ...
  msgArray.push(`My invocation method is using prefixes, currently, I only respond to messages beginning with -`);
